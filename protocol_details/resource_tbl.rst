...
is responsible for configuring the resources needed by the remote processor (shared memory, trace
buffers, vendor specific resources).

.. doxygenstruct:: resource_table
...
.. doxygenstruct:: fw_rsc_vdev_vring
   :project: openamp_doc_embed
